// Package em192 is EM192's fixture: a props package whose own compile
// fails because of an import path no module in any GOPATH or module
// graph provides. Resolver.Resolve must report this
