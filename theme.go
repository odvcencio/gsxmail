...
// DarkMode "adaptive" strategy swaps to under prefers-color-scheme.
...
// TerminalTheme returns a dark, mono-forward named theme:
// green-on-near-black, DarkMode "locked". It is deliberately not any one
// product's own private brand palette. See the README's "Named themes"
// section for the full palette and its EM140-144 proof.
func TerminalTheme() Theme {
	return renderhtml.TerminalTheme()
}

// LedgerTheme returns a warm, print-like light named theme, DarkMode
// "adaptive" with its own companion Dark palette. See the README's
// "Named themes" section for the full palette.
